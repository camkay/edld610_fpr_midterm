...
final_plots$plots[[3]]
final_plots$plots[[5]]
final_plots$plots[[10]]
final_plots$plots[[50]]
final_plots$plots[[100]]
...
final_plots %<>%
  mutate(path = paste(district, school, academic_year, sep = "_"),
         path = gsub(" ", "_", path),
         path = tolower(path))

fs::dir_create(here::here("plots", "gaps"))

files <- final_plots$path
  
paths <- here::here("plots", "gaps", glue("{files}.png"))
paths
